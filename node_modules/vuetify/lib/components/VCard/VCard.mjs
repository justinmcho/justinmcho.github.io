...
import { VCardActions, VCardAvatar, VCardHeader, VCardHeaderText, VCardImg, VCardMedia, VCardSubtitle, VCardText, VCardTitle } from "./index.mjs";
  ...
  setup(props, {
    ...
    return () => {
      ...
      return _withDirectives(_createVNode(Tag, {
        ...
        }), slots.media && _createVNode(VCardMedia, null, {
          default: slots.media
        }), hasHeader && _createVNode(VCardHeader, null, {

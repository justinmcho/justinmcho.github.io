...
// Styles
import "./VBtn.sass"; // Components

import { VIcon } from "./../index.mjs"; // Composables
  ...
  setup(props, {
    ...
    return () => {
      ...
      return _withDirectives(_createVNode(Tag, {
        ...
        _: 1
      }, 8, ["type", "class", "style", "disabled", "href", "onClick"]), [[_resolveDirective("ripple"), !props.disabled, null]]);
    };
  }

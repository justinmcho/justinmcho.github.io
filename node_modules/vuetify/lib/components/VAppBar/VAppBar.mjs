...
import { VImg } from "./../index.mjs"; // Composables
...
import { makeProps } from "../../util/makeProps.mjs"; // Types
...
export default defineComponent({
  ...
  setup(props, {
    ...
    const extension = ref(!!slots.extension);
    const height = computed(() => Number(props.prominent ? props.prominentHeight : props.height) + Number(extension.value ? props.extensionHeight : 0) - (props.density === 'comfortable' ? 8 : 0) - (props.density === 'compact' ? 16 : 0));
    ...
    return () => {
      ...
      return _createVNode(props.tag, {
        ...
        }, [slots.append()])]), slots.extension && _createVNode("div", {

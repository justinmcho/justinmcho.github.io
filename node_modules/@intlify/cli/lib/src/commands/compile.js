...
const builder = (args) => {
    return args
        ...
        alias: 'm',
        default: 'production',
        describe: i18n_1.t("the compiled i18n resource mode, 'production' or 'development' (default: 'production')")
    });
};
...
const handler = async (args) => {
    ...
    const ret = await api_1.compile(args.source, output, {
        ...
        onCompile: (source, output) => {
            console.log(chalk_1.default.green(i18n_1.t('Success compilation: {source} -> {output}', { source, output })));
        },
